...
export default async function StoreAffiliatesPage() {
  ...
  return <div className="mx-auto max-w-7xl space-y-7" dir="rtl">
    <header><p className="font-bold text-[var(--primary)]">نمو المبيعات</p><h1 className="mt-2 text-2xl font-black">التسويق بالعمولة</h1><p className="mt-2 max-w-3xl text-sm leading-7 text-[var(--muted-foreground)]">أنشئ روابط للمسوّقين، تتبع الطلبات المؤهلة، واعتمد العمولة بعد التسليم وفترة التعليق. الإسناد يعتمد آخر رابط صالح.</p></header>
