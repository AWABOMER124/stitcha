...
export default async function AiGeneratorPage() {
  ...
  return <AiGeneratorClient generationDisabledReason={!canGenerate ? 'هذه الميزة غير متاحة في باقتك.' : exhausted ? 'استهلكت حصة التوليد المتاحة؛ ما زال بإمكانك معاينة مسوداتك المحفوظة.' : undefined} initialDrafts={drafts.map((draft) => ({ ...draft, createdAt: draft.createdAt.toISOString() }))} />;
}
