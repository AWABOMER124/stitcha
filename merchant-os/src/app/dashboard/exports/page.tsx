...
const exports = [
  ...
  ['affiliates', 'المسوّقون بالعمولة', 'بيانات المسوّقين والروابط والزيارات والطلبات المنسوبة'],
  ['affiliate-commissions', 'عمولات المسوّقين', 'الطلبات والمبالغ والحالات وفترات التعليق ومراجع السداد'],
] as const;
