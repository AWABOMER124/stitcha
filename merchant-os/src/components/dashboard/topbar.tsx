        ...
        <div className="hidden sm:block">
          <div className="relative">
            ...
            <input
              ...
              className="w-80 rounded-lg border border-[var(--input)] bg-transparent py-2 pl-10 pr-4 text-sm outline-none transition-colors placeholder:text-[var(--muted-foreground)] focus:border-[var(--ring)] focus:ring-2 focus:ring-[var(--ring)]/20"
            />
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <button className="flex items-center gap-3 rounded-lg px-2 py-1.5 transition-colors hover:bg-[var(--muted)]">
          ...
          <div className="hidden text-left md:block">
            ...
            <p className="text-[10px] text-[var(--muted-foreground)]">Merchant Owner</p>
          </div>
