...
function buildNavItems(nav: Dictionary["navDashboard"]): NavItem[] {
  return [
    ...
    { type: "link", label: nav.customDomain, href: "/dashboard/domains", icon: "🔗" },
    ...
    { type: "link", label: nav.paymentMethods, href: "/dashboard/storefront/payments", icon: "🏦" },
    { type: "link", label: nav.inbox, href: "/dashboard/inbox", icon: "💬" },
    { type: "link", label: nav.complaints, href: "/dashboard/complaints", icon: "🛟" },
    ...
    { type: "link", label: nav.invoices, href: "/dashboard/invoices", icon: "🧮" },
    { type: "link", label: nav.dataExport, href: "/dashboard/exports", icon: "📊" },
    ...
    { type: "link", label: nav.affiliates, href: "/dashboard/affiliates", icon: "📣" },
    { type: "link", label: nav.referrals, href: "/dashboard/referrals", icon: "🤝" },
    { type: "link", label: nav.verification, href: "/dashboard/verification", icon: "🪪" },
    ...
    { type: "link", label: nav.deliveryPartners, href: "/dashboard/delivery/partners", icon: "🧩" },
