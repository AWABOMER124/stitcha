...
function buildNavItems(nav: Dictionary["navDashboard"]): NavItem[] {
  return [
    ...
    { type: "link", label: "الدومين الخاص", href: "/dashboard/domains", icon: "🔗" },
    ...
    { type: "link", label: "التسويق بالعمولة", href: "/dashboard/affiliates", icon: "📣" },
    { type: "link", label: "إحالة التجار", href: "/dashboard/referrals", icon: "🤝" },
    { type: "link", label: "تأكيد الهوية", href: "/dashboard/verification", icon: "🪪" },
